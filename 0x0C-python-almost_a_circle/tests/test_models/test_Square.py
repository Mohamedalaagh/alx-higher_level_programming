...
def test_str(self):
    ...
    self.assertEqual(str(self.sq1), "[Square] (1) 0/0 - 1")
    self.assertEqual(str(self.sq2), "[Square] (2) 3/0 - 2")
    self.assertEqual(str(self.sq3), "[Square] (3) 5/6 - 4")
    self.assertEqual(str(self.sq4), "[Square] (10) 8/9 - 7")
