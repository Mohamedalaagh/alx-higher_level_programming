...
class TestRectangle(unittest.TestCase):
    ...
    def test_to_dictionary(self):
        ...
        self.assertDictEqual(i.to_dictionary(), output)
        i = Rectangle(1, 3, 5)
    ...
    def test_exception(self):
        """test with exception"""
        i = Rectangle(1, 2, 3, 4, 6)
        self.assertRaises(TypeError, i.to_dictionary, 0)
        i = Rectangle(1, 2)
        self.assertRaises(TypeError, i.to_dictionary, None)
