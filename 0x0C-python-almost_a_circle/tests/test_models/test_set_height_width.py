"""
Unit tests for the setter and getter methods of height and width in the Rectangle class
"""
...
class TestRectangleSetterGetter(unittest.TestCase):
    ...
    def test_height_setter_dict(self):
        """Test to set a dictionary to the height"""
        rect = Rectangle(2, 3, 4, 5, 6)
        with self.assertRaises(TypeError):
            rect.height = {12}
