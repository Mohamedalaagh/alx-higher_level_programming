...
This script sends an HTTP GET request to the \
        URL https://intranet.hbtn.io/status
and prints the body of the response. The response details \
...
Functions:
    main(): Sends a GET request to the URL and prints the \
...
def main():
    ...
    This function sends an HTTP GET request to the \
